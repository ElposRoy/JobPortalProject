...
defineProps(['dialogEducation','dialogSkill','dialogExperience']);
...
<template>
  ...
  :class="{
    'hidden': !(dialogEducation || dialogSkill || dialogExperience),
  'modal-open': dialogEducation || dialogSkill || dialogExperience,
}"
  aria-modal="true"
  role="dialog"
>
