...
<template>
  ...
  :class="{
    'hidden': !(dialogEducation || dialogSkill || dialogExperience || dialogResumeHead || dialogContact),
  'modal-open': dialogEducation || dialogSkill || dialogExperience || dialogResumeHead || dialogContact,
}"
  aria-modal="true"
  role="dialog"
>
