...
// close/remove/hide/ etc.
  ...
  FinalNextButton(overallForm,ResumePFP,PersonalInfo,EducationArray,showSkillAddedd,ExperienceArray){
    ...
    overallForm.BirthPlace = PersonalInfo.BirthPlace;
...
<p class="mt-1 text-sm text-gray-500 dark:text-gray-300 mb-5" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
   ...
   <div v-show="Step2">
    ...
    <div class="col-span-1">
      ...
      <!-- Birthday -->
      <div class="relative z-0 w-full mb-6 group">
        <input v-model="PersonalInfo.BirthDate" type="text" name="BirthDate" 
        id="BirthDate" 
        ...
        peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Date of Birth</label>
    </div>
